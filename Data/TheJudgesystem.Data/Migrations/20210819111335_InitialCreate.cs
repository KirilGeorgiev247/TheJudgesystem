        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StartOfTheWorkDay = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Raises = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LawyerId = table.Column<int>(type: "int", nullable: true),
                    JuryId = table.Column<int>(type: "int", nullable: true),
                    ProsecutorId = table.Column<int>(type: "int", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsSolved = table.Column<bool>(type: "bit", nullable: false),
                    LawyerDefence = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProsecutorDecision = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JudgeDecision = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IndicationId = table.Column<int>(type: "int", nullable: true),
                    CaseId = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Witnesses_Indications_IndicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Indications_CaseId",
                table: "Indications",
                column: "CaseId");

            migrationBuilder.CreateIndex(
                name: "IX_Indications_IsDeleted",
                table: "Indications",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Indications_WitnessId",
                table: "Indications",
                column: "WitnessId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Witnesses_IndicationId",
                table: "Witnesses",
                column: "IndicationId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Indications_Cases_CaseId",
                table: "Indications",
                column: "CaseId",
                principalTable: "Cases",
                principalColumn: "Id",
